...
import gay.menkissing.bulbus.client.content.renderers.{RepairMachineRenderer, StasisAccessorBlockEntityRenderer, TunableChestRenderer}
...
object BulbusBlockEntityRenderers:
  def register(): Unit =
    ...
    BlockEntityRenderers.register(BulbusBlockEntities.tunableChest, TunableChestRenderer.apply)
